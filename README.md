...
3. **Restart** any open PowerShell windows to activate the utility. 
...
3. Open a terminal in the `Linux` folder and run:
   ...
   ```
4. **Restart** `pwsh`. 
   * *Note: The Ctrl+Shift+C binding works if your terminal supports passing those keys.* 

---

### 🚀 How to Use
1. Use PowerShell or your terminal as you normally would. 
2. When you want to capture the last command and its results, press: 
   > **`[Ctrl] + [Shift] + [C]`** 
3. The content is now in your clipboard. 
4. **Paste** it anywhere (Slack, GitHub, Documentation, etc.).
